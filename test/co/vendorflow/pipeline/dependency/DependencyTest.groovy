package co.vendorflow.pipeline.dependency
...
class DependencyTest extends Specification {
    ...
    def "RAF factory returns correct values"(String raf, String groupId, String artifactId, String version) {
        ...
        'co.vendorflow.service.emailsender:email-sender-api:jar:1.2.0:compile' || 'co.vendorflow.service.emailsender' | 'email-sender-api' | '1.2.0'
